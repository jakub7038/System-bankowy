...
public class ClientService {
    ...
    public String createClient(String pesel, String firstName, String lastName,
    ...
    public String updateClientFirstName(String pesel, String newFirstName) {
        return updateClientDetail("client_pkg.UPDATE_FIRST_NAME", pesel, newFirstName);
    }

    public String updateClientLastName(String pesel, String newLastName) {
        return updateClientDetail("client_pkg.UPDATE_LAST_NAME", pesel, newLastName);
    }

    public String updateClientMiddleName(String pesel, String newMiddleName) {
        return updateClientDetail("client_pkg.UPDATE_MIDDLE_NAME", pesel, newMiddleName);
    }

    public String updateClientPhoneNumber(String pesel, String newPhoneNumber) {
        return updateClientDetail("client_pkg.UPDATE_PHONE_NUMBER", pesel, newPhoneNumber);
    }

    private String updateClientDetail(String procedure, String pesel, String newValue) {
        String result = null;
